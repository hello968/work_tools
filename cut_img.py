    ...
    for i in os.listdir(nine_path):
        if i[-3:] == "png":
            ...
            if (w_num == int(w / W)):
                ...
                for t in range(int(w_num / 2)):
                    w_list.append(t * W)
                w_list.append(int(w / 2 - W / 2))
...
if __name__=="__main__":
    img_path="D:/406S-A(20201013)/biaozhu/save_masks/"
    ...
    nine_path = "D:/406S-A(20201013)/biaozhu/save_masks/half_imgs/"
